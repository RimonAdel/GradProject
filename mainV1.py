...
def front_image_measurments(front_image, points_dict):
    ...
    #right elbow outer
    cv2.circle(front_image, points_dict["right_elbow_outer_point"], point_radius, right_elbow_outer_color, -1)
    #right elbow inner
    cv2.circle(front_image, points_dict["right_elbow_inner_point"], point_radius, right_elbow_inner_color, -1)
    #left elbow inner
    cv2.circle(front_image, points_dict["left_elbow_inner_point"], point_radius, left_elbow_inner_color, -1)
    #left elbow outer
    cv2.circle(front_image, points_dict["left_elbow_outer_point"], point_radius, left_elbow_outer_color, -1)

    #right chest and arm meeting
    cv2.circle(front_image, points_dict["right_chest_arm_meeting_point"], point_radius, right_chest_arm_meeting_color, -1)
    #left chest and arm meeting
    cv2.circle(front_image, points_dict["left_chest_arm_meeting_point"], point_radius, left_chest_arm_meeting_color, -1)
    ...
    #stone of trousers
    cv2.circle(front_image, points_dict["stone_of_trousers_point"], point_radius, stone_of_trousers_color, -1)

    #right Knee outer 
    cv2.circle(front_image, points_dict["right_Knee_outer_point"], point_radius, right_Knee_outer_color, -1)
    #right Knee inner
    cv2.circle(front_image, points_dict["right_Knee_inner_point"], point_radius, right_Knee_inner_color, -1)
    
    #left Knee inner
    cv2.circle(front_image, points_dict["left_Knee_inner_point"], point_radius, left_Knee_inner_color, -1)
    #left Knee outer
    cv2.circle(front_image, points_dict["left_Knee_outer_point"], point_radius, left_Knee_outer_color, -1)

    #right ankle outer
    cv2.circle(front_image, points_dict["right_ankle_outer_point"], point_radius, right_ankle_outer_color, -1)
    #right ankle inner
    cv2.circle(front_image, points_dict["right_ankle_inner_point"], point_radius, right_ankle_inner_color, -1)
    
    #left Knee inner
    cv2.circle(front_image, points_dict["left_ankle_inner_point"], point_radius, left_ankle_inner_color, -1)
    #left Knee outer
    cv2.circle(front_image, points_dict["left_ankle_outer_point"], point_radius, left_ankle_outer_color, -1)    
...
def side_image_measurments(side_image,points_dict):
    ...
    # trousers front
    cv2.circle(side_image, points_dict["trousers_front_point"], point_radius, trousers_front_color, -1)
    # trousers back
    cv2.circle(side_image, points_dict["trousers_back_point"], point_radius, trousers_back_color, -1)
...
if __name__ == "__main__":
    ...
    front_image_points_dict = XMLHandler.read_file("front_keypoints/"+user_name+"_front")
    ...
    for  key in true_measurments_dict:
        ...
        for measurement in true_measurments_dict[key]:
            ...
            i += 1
            print(measurement,"====>  ",end="")
        true_measurments_average_dict[key] = average/i
        print()
        print("#"*40)
    ...
    print(result_dict)
    XMLHandler.write(result_dict,"results/"+user_name)
